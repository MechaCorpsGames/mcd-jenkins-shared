...
**YOU ARE IN: `mcdjenkins/polecats/rust/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/mcdjenkins/` (rig root) or other directories
...
**Your mail address:** `mcdjenkins/polecats/rust`
**Your rig:** mcdjenkins
**Your Witness:** `mcdjenkins/witness`
...
| Ask Witness for help | `gt mail send mcdjenkins/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`mcdjenkins/witness`) when:
...
```bash
gt mail send mcdjenkins/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
