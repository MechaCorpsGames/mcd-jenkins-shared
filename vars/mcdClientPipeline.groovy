    ...
    pipeline {
        agent {
            docker {
                ...
                args '-v /var/run/docker.sock:/var/run/docker.sock -v /var/lib/jenkins/.android:/var/lib/jenkins/.android:ro -v /var/lib/jenkins/.local/share/godot:/home/jenkins/.local/share/godot:ro -v /opt/mechacorps:/opt/mechacorps -v /var/opt/mechacorpsgames/Src:/var/opt/mechacorpsgames/Src --network host --group-add 111'
            }
        }
