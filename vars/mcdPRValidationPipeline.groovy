                    ...
                    script {
                        def testResult = sh(script: '''
                            ...
                            cleanup() {
                                ...
                                # happened to be doing 120s later. The 40-line
                                # tails above can miss it: the stall opens early
                                # and the log keeps growing for another two
                                # minutes. Grep for it directly instead.
                                echo ""
