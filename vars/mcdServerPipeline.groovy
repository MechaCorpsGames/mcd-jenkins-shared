            ...
            stage('Deploy GameServer & TestClient') {
                ...
                steps {
                    sh """
                        ...
                        mkdir -p ${config.deployPath}/versions ${config.deployPath}/testclient-versions ${config.deployPath}/Data/GameData ${config.deployPath}/leases/versions ${config.deployPath}/leases/testclient-versions
