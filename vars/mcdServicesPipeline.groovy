// MechaCorps Services Pipeline - Shared Library
// Deploys: Auth, CrashReporting+MCP, Wiki sync, Monitoring
    ...
    pipeline {
        ...
        triggers {
            GenericTrigger(
                ...
                regexpFilterExpression: "refs/heads/${config.branch}.*(Src/Auth|Src/Shared|Src/CrashReporting|Src/MCPServer|Src/Monitoring|Src/Wiki|docs/wiki|Src/docker-compose\\.(auth|crash-reporting|monitoring)).*"
            )
        }
